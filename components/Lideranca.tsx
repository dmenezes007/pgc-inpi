...
const conhecimentoIcons: { [key: string]: React.ReactNode } = {
    'Visão de Futuro': <FontAwesomeIcon icon={faBullseye} className="h-6 w-6 text-orange-400" />,
    'Inovação e Mudança': <FontAwesomeIcon icon={faFlask} className="h-6 w-6 text-orange-400" />,
    'Comunicação Estratégica': <FontAwesomeIcon icon={faBullhorn} className="h-6 w-6 text-orange-400" />,
    'Geração de Valor para o Usuário': <FontAwesomeIcon icon={faCircleNodes} className="h-6 w-6 text-orange-400" />,
    'Gestão para Resultados': <FontAwesomeIcon icon={faWaveSquare} className="h-6 w-6 text-orange-400" />,
    'Gestão de Crises': <FontAwesomeIcon icon={faShield} className="h-6 w-6 text-orange-400" />,
    'Autoconhecimento e Desenvolvimento Pessoal': defaultIcon,
    'Engajamento de Pessoas e Equipes': <FontAwesomeIcon icon={faUsers} className="h-6 w-6 text-orange-400" />,
    'Coordenação e Colaboração em Rede': <FontAwesomeIcon icon={faGears} className="h-6 w-6 text-orange-400" />,
};
